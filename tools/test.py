...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default='D:/mestrado/OpenPCDet/output/ubc3v_models/vps_pose/default/ckpt/latest_model.pth', help='checkpoint to start from')
